...
edgeConst = median(rawsig(1:constWindow));
extendsig(1:extendWindow) = ...
    edgeConst + stddfset * randn(1,extendWindow);
edgeConst = median(rawsig(end-constWindow+1:end));
...
my_error = ...
    sqrt(mean((acc_power_noise-extrapolated_acc_power_noise).^2))*10000;
